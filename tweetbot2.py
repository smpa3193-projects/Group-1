...
all_words = []
infinite_tweets = twitter.search(q='#InfiniteKusama', count=1000, geocode= '38.9072, -77.0369, 10mi')
yayoi_tweets = twitter.search(q='#YayoiKusama', count=1000, geocode= '38.9072, -77.0369, 10mi')
